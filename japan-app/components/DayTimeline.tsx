...
import { Train, MapPin, Bed, LogIn, Plus, Check, X, Pencil, Trash2 } from 'lucide-react';
    ...
    return (
      <div className="space-y-1.5">
          ...
          <div key={idx} className="group flex items-center gap-2">
            {editingIdx === idx ? (
              ...
              <>
                ...
                <div
                  className={`flex-1 text-[11px] text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-800/40 hover:bg-slate-200 dark:hover:bg-slate-800/70 px-3 py-2 rounded-lg border border-slate-200 dark:border-slate-700/20 transition-all leading-snug cursor-pointer ${!act.time ? 'ml-[46px]' : ''}`}
        ...
        {isAdding ? (
          ...
          <button onClick={beginAdding} className="flex items-center gap-2 mt-1 text-[11px] font-bold text-slate-500 dark:text-slate-600 hover:text-blue-500 dark:hover:text-blue-400 transition-colors">
